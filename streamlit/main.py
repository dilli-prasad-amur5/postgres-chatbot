from database import fetch_table_data, insert_embeddings
from file_processing import extract_text_from_pdf, split_text_into_chunks, get_embeddings
import psycopg2
import os
...
Present your response clearly and concisely. Avoid making assumptions if the context is ambiguous or insufficient. Use the context as it is provided, maintaining its intent and details. If asked for unsupported information, respond honestly and professionally. Where possible, suggest ways to obtain missing information.
